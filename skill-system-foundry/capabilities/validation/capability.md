...
- `--check-prose-yaml`: Validate ```` ```yaml ```` fences in `SKILL.md`, `../**/*.md`, and `../../references/**/*.md`. See [authoring-principles.md](../../references/authoring-principles.md) for the counter-example convention and [yaml-support.md](../../references/yaml-support.md) for the supported grammar surface.
